...
public class Leader extends User {
    ...
    private String userName = "leader";
    private String passWord = "leader";
    ...
    public void editLeader (Leader inputLeader) {
    ...
    public void leadersPublicMenu (ArrayList<Leader> leaders) {
        Scanner sc = new Scanner(System.in);
        System.out.println("\n\nThis is leaders menu :\nEnter 1 to see the leaders\nEnter 2 to search a leader\n");
    ...
    public void leadersMenu(ArrayList<Leader> leaders) {
        ...
        switch (input) {
            ...
            case 2:
                ...
                System.out.println("How many regions you want to add for this leader ?");
    ...
    public void regionAdder (Regions[] regions, int regNum) {
